...
VALUES ('titre 1', 'chapo 1', 'content 1', ADDDATE(NOW(), INTERVAL -12 HOUR), NOW(), 2),
       ('titre 2', 'chapo 2', 'content 2', ADDDATE(NOW(), INTERVAL -9 HOUR), NOW(), 3),
       ('sans commentaire', 'chapo 3', 'content 3', NOW(), NOW(), 2);
