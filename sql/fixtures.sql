...
INSERT INTO user(pseudo, role_utilisateur, email, password, createdAt, updatedAt)
...
INSERT INTO article(title,chapo,content,createdAt, updatedAt,id_user)
...
INSERT INTO comment(content, createdAt, isActive, id_user, id_article)
